...
export const SERVER_DATA = {
    DEFAULT_SERVICES: {
        ...
        "imap-server":{
            ...
            "serviceSlug": "imap-server",
            "imageName": "dovecot/dovecot",
            "serviceDescription": "An open-source IMAP server which connects to the IMAP server and provides a secure and reliable way to access email messages.",
            "serviceType": "Application",
            "servicePort": ["8080", "34190", "31024", "31587", "31993", "31143", "31110", "31995 ","9090"],
            "serviceStatus": false,
            "auth_required": true,
        },
        "imap-client":{
            "serviceId": 11,
            "serviceName": "RoundeCube Webmail Service",
            "serviceSlug": "imap-client",
            "imageName": "roundcube/roundcubemail",
            "serviceDescription": "A Webmail Service that provides a secure and reliable way to access email messages.",
            "serviceType": "Application",
            "servicePort": ["80"],
            "serviceStatus": false,
            "auth_required": false,
