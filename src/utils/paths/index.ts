...
export const COMMANDS = {
    ...
    PM2: {
        ...
        LOGS: "pm2 logs",
        STATUS: "pm2 status",
        START_ALL: "pm2 startOrRestart all",
        STOP_ALL: "pm2 stop all",
        RESTART_ALL: "pm2 restart all",
        START_MONITORING: "pm2 monitor",
        STOP_MONITORING: "pm2 unmonitor",
        RESTART_MONITORING: "pm2 restart pm2-monitor",
        GET_PM2_VERSION: "pm2 -v",
        GET_PM2_STATUS: "pm2 status",
        GET_ALL_APPS: "pm2 list",
        GET_APP_STATUS: "pm2 show {id}",
        GET_APP_LOGS: "pm2 logs {id}",
        GET_APP_INFO: "pm2 info {id}",
        GET_APP_MEMORY_USAGE: "pm2 monit {id}",
        GET_APP_CPU_USAGE: "pm2 top {id}",
        GET_APP_START_TIME: "pm2 start_time {id}",
        GET_APP_END_TIME: "pm2 end_time {id}",
    },
    SSL: {
