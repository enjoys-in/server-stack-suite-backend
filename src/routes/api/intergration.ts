...
router.get("/sso/:provider", IntegrationController.default.getApp)
router.post("/sso", IntegrationController.default.createApp)
router.delete("/sso/:id", IntegrationController.default.deleteApp)
